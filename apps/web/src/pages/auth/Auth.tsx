          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col">
              <input
                ...
                className={`w-full bg-white p-2 rounded-md border ${errors.email ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary`}
              />
            ...
            {!login && (
              <div className="flex flex-col">
                <input
                  ...
                  className={`w-full bg-white p-2 rounded-md border ${errors.firstName ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary`}
            ...
            {!login && (
              <div className="flex flex-col">
                <input
                  ...
                  className="w-full bg-white p-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
            )}
            ...
            <div className="flex flex-col relative">
              <input
                ...
                className={`w-full bg-white p-2 rounded-md border ${errors.password ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary pr-10`}
              />
              <div
            ...
            {!login && (
              <div className="flex flex-col relative">
                <input
                  ...
                  className={`w-full bg-white p-2 rounded-md border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-primary pr-10`}
                />
                <div
                  className="absolute right-2 top-2 cursor-pointer w-6 h-6 text-gray-600"
